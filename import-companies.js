//import-companies.js
document.querySelector("#csv-upload-form")?.addEventListener("submit", async (e) => {
    e.preventDefault();

    const fileInput = document.querySelector("#csv-upload-companies");
    const message = document.querySelector("#csv-upload-companies-message");
    message.textContent = "";
    message.style.color = "";

    // ✅ Wait for Supabase client to load (if you need it later)
